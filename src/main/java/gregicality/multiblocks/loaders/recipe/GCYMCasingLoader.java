...
public final class GCYMCasingLoader {
    ...
    public static void init() {
        ...
        ModHandler.addShapedRecipe(true, "casing_crushing_wheels",
                GCYMMetaBlocks.UNIQUE_CASING.getItemVariant(BlockUniqueCasing.UniqueCasingType.CRUSHING_WHEELS,
                        numCasings),
        ...
        ModHandler.addShapedRecipe(true, "casing_slicing_blades",
                GCYMMetaBlocks.UNIQUE_CASING.getItemVariant(BlockUniqueCasing.UniqueCasingType.SLICING_BLADES,
                        numCasings),
        ...
        ModHandler.addShapedRecipe(true, "casing_electrolytic_cell",
                GCYMMetaBlocks.UNIQUE_CASING.getItemVariant(BlockUniqueCasing.UniqueCasingType.ELECTROLYTIC_CELL,
                        numCasings),
        ...
        ModHandler.addShapedRecipe(true, "casing_heat_vent",
                GCYMMetaBlocks.UNIQUE_CASING.getItemVariant(BlockUniqueCasing.UniqueCasingType.HEAT_VENT, numCasings),
                "PDP",
        ...
        RecipeMaps.ASSEMBLER_RECIPES.recipeBuilder()
                ...
                .outputs(GCYMMetaBlocks.UNIQUE_CASING.getItemVariant(BlockUniqueCasing.UniqueCasingType.HEAT_VENT,
                        numCasings))
                .duration(50).EUt(16).buildAndRegister();
